        ...
        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
            <div class="configurations">                
                <table>
                    <tbody>    
                        <tr>
                            <td><label for="text">Баар код</label></td>
                            <td>
                                <div class="generate" style="float: left"><?php echo getInputTextHtml('text', $text, array('type' => 'text', 'required' => 'required')); ?> <input type="submit" value="Үүсгэх" /></div>                            
                            </td>
                        </tr>
                    </tbody>
                </table>        
